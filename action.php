				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@DOD.com / [Gpay-9361331036]">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/DOD/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/DOD/cancel.php"/>
